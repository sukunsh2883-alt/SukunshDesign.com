...
export default function Footer({ profile }: FooterProps) {
  return (
    <footer id="contact" className="relative bg-[#8277e7] px-6 pb-14 pt-24 text-[#18005a] md:px-12 md:pb-20 md:pt-28">
      <div className="mx-auto max-w-[1520px]">
        <div className="mb-20 grid gap-10 md:grid-cols-[1.4fr_0.45fr_0.45fr]">
          ...
          <p className="text-sm uppercase md:text-base">Mumbai, India</p>
        </div>

        <div className="flex items-center justify-between border-t border-[#18005a]/70 pt-8">
          <p className="text-xs font-semibold uppercase tracking-wide">
            2026 © Sukunsh. All rights reserved
          </p>
          <a
            href={`mailto:${profile.email}`}
            className="rounded-full bg-[#18005a] px-7 py-4 text-xs font-semibold uppercase text-white hover:bg-[#f25a00]"
          >
            Let&apos;s Connect
          </a>
        </div>
